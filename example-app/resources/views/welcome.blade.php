                        ...
                        <div class="navbar-nav py-0">
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="blog.html" class="dropdown-item">Berita</a>
                                    <a href="single.html" class="dropdown-item">Galeri</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Profil</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="blog.html" class="dropdown-item">Tentang Sekolah</a>
                                    <a href="single.html" class="dropdown-item">Visi & Misi</a>
                                    <a href="single.html" class="dropdown-item">Kepala Sekolah</a>
                                    <a href="single.html" class="dropdown-item">Guru</a>
                                    <a href="single.html" class="dropdown-item">Prestasi Sekolah</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Osis</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="blog.html" class="dropdown-item">Tentang Osis</a>
                                    <a href="single.html" class="dropdown-item">Pengurus Osis</a>
                                    <a href="single.html" class="dropdown-item">Kegiatan</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
